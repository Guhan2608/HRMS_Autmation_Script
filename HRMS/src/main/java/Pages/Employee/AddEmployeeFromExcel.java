...
public class AddEmployeeFromExcel {
    ...
    public void fillEmployeeFormOld(String locatorFile, String dataFile) {
        WebDriver driver = DriverManager.getDriver();
    ...
    private boolean validateEnteredValueEnhanced(WebDriver driver, WebElement element, String expectedValue, String fieldType, String locatorValue) {
        try {
            String actualValue = "";
...
//            String empNumber = dataRow.getOrDefault("EmployeeNumber", "Emp_" + (empIndex + 1));
            ...
            if (isEmployeePassed) passCount++; else failCount++;
        }
